...
export default function CourierSignIn() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // Courier giriş API-si
      const response = await fetch("/api/auth/courier/signin", {
        method: "POST",
        headers: {
        ...
        <Card className="bg-white border-gray-200 shadow-2xl">
          <CardHeader className="text-center pb-8">
            ...
            <CardTitle className="text-3xl font-bold text-gray-900 mb-2">
              Courier Login / Kuryer Girişi
            </CardTitle>
            <p className="text-gray-600">
              Sign in to start delivering and earning.
              / Çatdırma və qazanmağa başlamaq üçün giriş edin.
            </p>
          </CardHeader>
          <CardContent>
