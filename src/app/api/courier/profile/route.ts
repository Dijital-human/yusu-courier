...
const profileUpdateSchema = z.object({
  ...
  phone: z.string().min(1, "Phone is required / Telefon tələb olunur").optional(),
  address: z.string().min(1, "Address is required / Ünvan tələb olunur").optional(),
  vehicleType: z.string().min(1, "Vehicle type is required / Nəqliyyat növü tələb olunur").optional(),
  licenseNumber: z.string().min(1, "License number is required / Lisenziya nömrəsi tələb olunur").optional(),
...
export async function PUT(request: NextRequest) {
  try {
    ...
    const { name, phone, address, vehicleType, licenseNumber, isActive } = validatedFields.data;
